	...
	class listener(StreamListener):
		...
		def on_data(self,data):
			...
			try:
				...
				print(text)
				if (('Kerala' in text) or ('kerala' in text) or ('KERALA' in text) or ('food' in text) or ('kit' in text) or ('volunteer' in text) or ('suppl' in text) or ('medic' in text) or ('requir' in text) or ('water' in text) or ('avail' in text) or ('need' in text) or ('call' in text) or ('resource' in text) or ('contact' in text)):
					print("First if crossed")
					if 'sex' in text or 'porn' in text or 'callgirl' in text or 'crore' in text or 'rupee' in text or 'onam' in text or 'lakh' in text or 'tour' in text or 'vacation' in text:
...
#					print("not added")
	...
	tweets.filter(track=["standwithkerala","kerala flood","keralafloods",
		"#keralaflood","#keralahealth","kerala health","#prayforkerala "
		"#Rescuekerala","keralarelieffund","kerala relief","rebuild kerala","#doforkerala ",
		"#anbodukochi ","#HelpKerala","#keralahelp","#KeralaDonationChallenge ",
		"#IndiaWithKerala","#KeralaSOS","kerala_rescue","anbodukochi","kerala rescue","#resources kerala", "resources kerala"])
