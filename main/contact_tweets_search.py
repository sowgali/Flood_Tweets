...
def analyze_tweets(tweets):
	...
	for tweet in tweets:
 		...
 		csv2.writerow([tweet_id, text, str(created_at)])
			...
			if 'sex' in text or 'porn' in text.lower() or 'callgirl' in text.lower()  or 'crore' in text.lower() or 'rupees' in text.lower() or 'million' in text.lower() or 'onam' in text.lower() or 'vacation' in text.lower() or 'travel' in text.lower() or 'tour' in text.lower():
				continue
...
def collect_tweets():
	...
	keywords = {'KeralaSOS':1000, 'keralafloodreliefs':1000, 'keralafloodrelief':1000, 'kerala floods contact':1000, 'kerala email':1000, '#keralafloods resources':1000, 'keralarelief':1000, 'keralafloods':1000}
